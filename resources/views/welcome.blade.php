                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="flex justify-center items-center border-b pb-2 last:border-b-0">
                            <td class="p-2 w-1/12 text-left"> 1 </td>
                            <td class="p-2 w-1/12"> <img src="{{ url('/images/user.jpeg') }}" alt="user"
                                    class="h-8 w-8 rounded-full"> </td>
                            <td class="p-2 w-2/12"> S A Faroque </td>
                            <td class="p-2 w-2/12"> 01915344418 </td>
                            <td class="p-2 w-4/12"> faroque.computer@gmail.com </td>
                            <td class="p-2 w-2/12"> 
                                <div class="flex items-center">
